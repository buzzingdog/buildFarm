...
{ 
	...
	Node sqlServerEC
	{
        ...
        Script OpenSqlPort
        {
            ...
            TestScript = {
                !((Get-NetFirewallRule -Name 'Sql Server') -eq $null)
            }
            SetScript = {
        ...
        Script SqlServerLogins
        {
            ...
            TestScript = {
                !((sqlcmd -S . -d master -Q "SELECT 'Found' FROM sys.server_principals WHERE name = N'BUILTIN\Administrators'" | Select-String 'found') -eq $null)
            }
            SetScript = {
        ...
        Script AddEcAdminsToRemoteDesktop
        {
            ...
            TestScript = {
                !((net localgroup "Remote Desktop Users" | Select-String 'CLOUD\\users_admin_ec') -eq $null)
            }
            SetScript = {
        ...
        Script AddEcAdminsToLocalAdmin
        {
            ...
            TestScript = {
                !((net localgroup "Administrators" | Select-String 'CLOUD\\users_admin_ec') -eq $null)
            }
            SetScript = {
